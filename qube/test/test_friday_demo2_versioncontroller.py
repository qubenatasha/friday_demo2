...
HELLO_VERSION = "/v1/friday_demo2/version"
...
class Testfriday_demo2VersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_friday_demo2_default_version(self, *args, **kwargs):
    ...
    def test_friday_demo2_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
