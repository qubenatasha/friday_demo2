...
from qube.src.api.friday_demo2controller import friday_demo2Controller
from qube.src.api.friday_demo2controller import friday_demo2ItemController
from qube.src.api.versioncontroller import friday_demo2ItemVersionController
...
api.add_resource(friday_demo2ItemVersionController, '/v1/friday_demo2/version')
api.add_resource(friday_demo2Controller, '/v1/friday_demo2')
api.add_resource(friday_demo2ItemController, '/v1/friday_demo2/<string:entity_id>')
