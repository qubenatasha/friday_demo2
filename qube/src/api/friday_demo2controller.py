...
from qube.src.api.swagger_models.friday_demo2 import friday_demo2Model # noqa: ignore=I100
from qube.src.api.swagger_models.friday_demo2 import friday_demo2ModelPost # noqa: ignore=I100
from qube.src.api.swagger_models.friday_demo2 import friday_demo2ModelPostResponse # noqa: ignore=I100
from qube.src.api.swagger_models.friday_demo2 import friday_demo2ModelPut # noqa: ignore=I100
...
from qube.src.api.swagger_models.response_messages import (
    ...
    put_response_msgs)
from qube.src.commons.error import friday_demo2ServiceError
...
class friday_demo2ItemController(Resource):
    @swagger.doc(
        {
            'tags': ['friday_demo2'],
            'description': 'friday_demo2 get operation',
    ...
    def get(self, authcontext, entity_id):
        ...
        try:
            ...
            data = friday_demo2Service(authcontext['context'])\
                .find_by_id(entity_id)
            clean_nonserializable_attributes(data)
        except friday_demo2ServiceError as e:
            LOG.error(e)
        ...
        return friday_demo2Model(**data), 200

    @swagger.doc(
        {
            'tags': ['friday_demo2'],
            'description': 'friday_demo2 put operation',
    ...
    def put(self, authcontext, entity_id):
        """
        updates an friday_demo2 item
        """
        try:
            model = friday_demo2ModelPut(**request.get_json())
            context = authcontext['context']
            friday_demo2Service(context).update(model, entity_id)
            return EMPTY, 204
        except friday_demo2ServiceError as e:
            LOG.error(e)
            return ErrorModel(**{'error_code': str(e.errors.value),
    ...
    @swagger.doc(
        {
            'tags': ['friday_demo2'],
            'description': 'friday_demo2 delete operation',
    ...
    def delete(self, authcontext, entity_id):
        """
        Delete friday_demo2 item
        """
        try:
            friday_demo2Service(authcontext['context']).delete(entity_id)
            return EMPTY, 204
        except friday_demo2ServiceError as e:
            LOG.error(e)
            return ErrorModel(**{'error_code': str(e.errors.value),
...
class friday_demo2Controller(Resource):
    @swagger.doc(
        {
            'tags': ['friday_demo2'],
            'description': 'friday_demo2 get operation',
    ...
    def get(self, authcontext):
        """
        gets all friday_demo2 items
        """
        LOG.debug("Serving  Get all request")
        list = friday_demo2Service(authcontext['context']).get_all()
    ...
    @swagger.doc(
        {
            'tags': ['friday_demo2'],
            'description': 'friday_demo2 create operation',
    ...
    def post(self, authcontext):
        """
        Adds a friday_demo2 item.
        """
        try:
            model = friday_demo2ModelPost(**request.get_json())
            result = friday_demo2Service(authcontext['context'])\
                .save(model)

            response = friday_demo2ModelPostResponse()
